...
const Madeby = () => {
  ...
  return (
    <div className="bg-[#1E1E1E] h-[4em] w-screen relative shadow-[0_0_25px_rgba(225,0,0,0.4)]  px-6 py-4 flex flex-col items-center justify-center text-[rgb(237,237,237)] max-md:shadow-none max-md:p-0 ">
